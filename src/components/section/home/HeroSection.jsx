  ...
  return (
    <div className="mainContHero w-full h-[300svh] relative bg-[#efe6e1] z-[-2]">
      <div className="stickyCont w-full h-[100svh] sticky top-0 left-0 overflow-hidden">
        ...
        {/* Detail */}
        <div className="w-1/5 h-fit absolute HeroMainDetails opacity-0 top-[22%] -translate-y-1/2 left-[2%] max-sm:top-[23%] max-sm:left-0  max-sm:w-full max-sm:px-5 pointer-events-auto z-[90]">
        ...
        {/* GET in TUCH */}
        <div className="w-1/5 h-fit absolute HeroMainDetails opacity-0 top-[20%] -translate-y-1/2 right-[2%] max-sm:top-[72%] max-sm:left-1/2 max-sm:-translate-x-1/2  max-sm:w-2/3 max-sm:px-5">
